...
test(`trans('epic::validation.required', {attribute: 'email'}) should return "The email field is required."`, () => {
    expect(trans('epic::validation.required', {attribute: 'email'})).toBe('The email field is required.');
});
...
test(`trans_choice('epic::message.minutes_ago', 2, {value: 2}) should return "There are some"`, () => {
    expect(trans_choice('epic::message.minutes_ago', 2, {value: 2})).toBe('2 minutes ago');
});
...
I use [Orchestra Testbench](http://orchestraplatform.com/docs/latest/components/testbench/) as my base Phpunit TestCase for testing PHP and [Jest](https://facebook.github.io/jest/) for testing my JavaScript.
